            ...
            <table class="w-min">
                <thead>
                    <tr class="border-b bg-slate-100">
                        <th class="px-8 py-4 text-left whitespace-nowrap">название типа организации</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b">
                        <th class="px-8 py-4 text-left whitespace-nowrap">
                            <a href="/legals/{{ $legal->id }}" class="underline hover:text-indigo-500 transition transition-duration-200">
                                {{$legal->title}}
                            </a>
                        </th>
                    </tr>
